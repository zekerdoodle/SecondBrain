...
TOOL_SERIALIZERS: Dict[str, Callable[[dict, str, bool], dict]] = {
    ...
    "ltm_search": serialize_query_tool(["query"]),
    "ltm_get_context": serialize_query_tool(["query"]),
    ...
    "ltm_stats": serialize_compact([]),
    "ltm_process_now": serialize_compact([]),
    "ltm_run_gardener": serialize_compact([]),
